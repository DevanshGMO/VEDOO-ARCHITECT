...
import BedroomImg from "../../assets/BedroomImg.png";
        ...
        >
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
              <span className="text-gray-900">Bed</span>
              <span className="text-amber-500"> Room</span>
            </h1>
            ...
            <p className="text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
              ...
              living. This is not just luxury; this is timeless distinction,
              made to be lived in and loved for generations.
            </p>
