...
const HowItWorks = () => {
  return (
    <div className="overflow-x-hidden">
      <AnimatedSection className="mb-10" animationClass="fade-in">
        <AboutSection />
      </AnimatedSection>

      <AnimatedSection className="mb-10" animationClass="slide-up" threshold={0.2}>
        <DecorSection />
      </AnimatedSection>

      <AnimatedSection className="mb-10" animationClass="slide-in-left">
        <DesignSteps />
      </AnimatedSection>

      <AnimatedSection className="mb-10" animationClass="fade-in threshold={0.5}">
